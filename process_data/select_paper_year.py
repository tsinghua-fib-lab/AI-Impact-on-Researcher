...
def fun(i):
    ...
    with open(os.path.join('.',f'selected_dict_year_{i}.pkl'),'wb') as f:
...
if __name__ == '__main__':
    ...
    def merge(i):
        with open(os.path.join('.',f'selected_dict_year_{i}.pkl'),'rb') as f:
    ...
    with open(os.path.join('.',f'paper_selected_dict_year.pkl'),'wb') as f:
        pickle.dump(selected_dict,f)

    del selected_dict

    for i in tqdm(range(51)):
        os.remove(os.path.join('.',f'selected_dict_year_{i}.pkl'))